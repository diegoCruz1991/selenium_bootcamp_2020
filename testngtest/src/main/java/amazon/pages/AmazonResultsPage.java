...
public class AmazonResultsPage extends BasePage {
    ...
    public void orderResultsBySortType(String sortType) {
        this.mainBodyResults.getTopSortSection().selectSortType(sortType);
    }

    public String obtainResultsInformation() {
        return this.mainBodyResults.getTopSortSection().getAllResultsInfoLabel();
    }
}