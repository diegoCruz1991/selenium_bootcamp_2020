...
//            Thread.sleep(2000);
            System.out.println("Pagina: " + i.getText());
            i.click();
    ...
    public static void creatureSelection(WebDriver driver) throws InterruptedException {
        ...
        if (entries.equals("0")) {
            ...
            System.out.println("    Total de elemento por pagina: " + totalCreatures);
            ...
            try {
                ...
                System.out.println("        Item seleccionado: " + creatureSelected.getText() + creatureSelected.getAttribute("href") + " -Numero en la lista: " + randomNum);
            } catch (Exception e){
            }
            ...
            try {
                ...
                System.out.println("     Item seleccionado: " + creatureSelected2.getText() + creatureSelected2.getAttribute("href") + " -Numero en la lista: " + randomNum);
            } catch (Exception e){
            }
